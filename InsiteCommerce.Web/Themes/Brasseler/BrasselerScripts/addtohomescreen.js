(function (window, document) {
    ...
    ath.intl = {
        ...
        en_us: {
            ios: '<img src="/Images/Default/favicon-32x32.png" /><br>To add this web app to the home screen: tap %icon and then <strong>Add to Home Screen</strong>.',
            android: '<img src="/Images/Default/favicon-32x32.png" /><br>To add this web app to the home screen open the browser option menu and tap on <strong>Add to homescreen</strong>. <small>The menu can be accessed by pressing the menu hardware button if your device has one, or by tapping the top right menu icon %icon.</small>'
        },
    ...
    // default options
    ath.defaults = {
        appID: 'brasselerusa.com',		// local storage name (no need to change)
    ...
    var webkit = !!_ua.match(/WebKit/i);
    ath.isMobileSafari = ath.isIDevice && webkit && !_ua.match(/CriOS/i) && !_ua.match(/OPiOS/i) && !_ua.match(/fxios/i);
