...
(function (insite) {
    ...
    (function (cart) {
        ...
        angular
            .module("insite")
            .directive("iscBrasselerCartTotalDisplay", function () { return ({
            restrict: "E",
            replace: true,
            ...
            link: function ($scope) {
                $scope.discountOrderFilter = function (promotion) {
                    return (promotion.promotionResultType === "AmountOffOrder" || promotion.promotionResultType === "PercentOffOrder" || promotion.promotionResultType === "DiscountSubscriptionShipping");
                };
...
//# sourceMappingURL=brasseler.cart-total-display.directive.js.map