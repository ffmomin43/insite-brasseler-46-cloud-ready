module insite.cart {
    ...
    angular
        .module("insite")
        .directive("iscBrasselerCartTotalDisplay", () => ({
            restrict: "E",
            replace: true,
            ...
            link: ($scope: any) => {
                $scope.discountOrderFilter = promotion =>
                    (promotion.promotionResultType === "AmountOffOrder" || promotion.promotionResultType === "PercentOffOrder" || promotion.promotionResultType === "DiscountSubscriptionShipping");
